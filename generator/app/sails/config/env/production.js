...
// Dont add pro here because of risky


{{#ifeq db "psql"}}
const POSTGRES_URL = process.env.POSTGRES_URL || 'postgresql://postgres@localhost:5435/postgresdb';
{{/ifeq}}
{{#ifeq db "mongo"}}
const MONGO_URL = process.env.MONGO_URL || 'mongodb://root:example@127.0.0.1:27017/database?authSource=admin';
{{/ifeq}}
